...
import 'package:pa2_kelompok07/screens/client/dpmdppa/report_cancel_screen.dart';
...
class DetailClientReportScreen extends StatefulWidget {
  final String noRegistrasi;

  const DetailClientReportScreen({super.key, required this.noRegistrasi});

  @override
  State<DetailClientReportScreen> createState() =>
      _DetailClientReportScreenState();
}

class _DetailClientReportScreenState extends State<DetailClientReportScreen> {
  @override
  void initState() {
    super.initState();
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                (detail?.dokumentasi?.urls != null &&
                        detail!.dokumentasi!.urls.isNotEmpty &&
                        detail.dokumentasi!.urls.first.isNotEmpty)
                    ? GestureDetector(
                      onTap: () {
                        ScreenNavigator(cx: context).navigate(
                          FlutterFlowExpandedImageView(
                            image: CachedNetworkImage(
                              imageUrl: detail.dokumentasi.urls.first,

                              fit: BoxFit.contain,
                            ),
                            allowRotation: false,
                            tag: detail.dokumentasi.urls.first,
